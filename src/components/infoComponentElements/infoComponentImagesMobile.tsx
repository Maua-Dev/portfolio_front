...
export default function InfoComponentImagesMobile({
  quantity,
  images,
}: InfoComponentProps) {
  ...
  if (quantity === 2) {
    return (
      <div className="relative flex flex-col items-center justify-center w-full max-w-sm h-[400px]">
        <div className="absolute top-1/4 left-1/3 -translate-x-1/2 w-6/5 h-auto rounded-3xl shadow-xl overflow-hidden z-20">
          <img
        ...
        <div className="absolute top-[calc(50%-150px)] left-[calc(50%-100px)] -translate-x-1/2 w-8/5 h-auto rounded-3xl shadow-2xl overflow-hidden z-10">
          <img
